...
def setup_run_logger(base_name: str, model_name: str, timestamp: str, reasoning_effort: str = "medium", text_verbosity: str = "medium", persona_set: str = "persona-v1") -> logging.Logger:
    """
    Set up a logger for an agent run with file output.
    ...
    """
    # Create logger
    logger = logging.getLogger(f"agent_run_{base_name}_{timestamp}")
    ...
    log_filename = f"{base_name}_{timestamp}_{model_name}_agent_run.log"
